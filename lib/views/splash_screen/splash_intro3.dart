...
class SplashIntroThird extends StatelessWidget {
  const SplashIntroThird({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          Image.asset(introScreen3,width: context.screenWidth,fit: BoxFit.cover,),
          Container(
                    ...
                    for (int i = 0; i < 4; i++) // Number of splash screens
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white.withOpacity(i == 2 ? 1 : 0.4),
